-- ============================================
-- MVP 1.0 Domain Tables Migration - Apply Script
-- ============================================
-- This script applies MVP 1.0 domain tables to Supabase.
-- Safe to run multiple times (idempotent).
-- 
-- Creates:
-- - Extension: pgcrypto
-- - Function: public.set_updated_at()
-- - Tables: projects, monthly_focus, weekly_tasks, routines, routine_completions
-- - RLS policies, triggers, indexes for all tables
-- ============================================
